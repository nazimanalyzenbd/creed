                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a class="btn btn-info" href="{{route('business-tags.create')}}">Add</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            @foreach($datas as $key=>$value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('business-tags.edit', $value->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
