                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form class="text-black" method="POST" action="{{route('subscription-plan.store')}}">
                                    @csrf
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Name<span class="requiredStar">*</span></label>
                                        <div class="col-sm-10">
                                            <input type="text" name="plan_name" id="plan_name" value="{{old('plan_name')}}" class="form-control" placeholder="" required>
                                            @error('plan_name')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" name="monthly_cost" id="monthly_cost" value="{{old('monthly_cost')}}" step="0.01" class="form-control" placeholder="" required>
                                            @error('monthly_cost')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" name="discount" id="discount" value="{{old('discount')}}" min="0" class="form-control" placeholder="">
                                            @error('discount')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" name="yearly_cost" id="yearly_cost" value="{{old('yearly_cost')}}" step="0.01" class="form-control" placeholder="" required>
                                            @error('yearly_cost')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
