                                ...
                                <div class="recent-comment m-t-15">
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img class="media-object mr-3" src="{{asset('assets/images/avatar/4.png')}}" alt="..."></a>
                                        </div>
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img class="media-object mr-3" src="{{asset('assets/images/avatar/2.png')}}" alt="..."></a>
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="media-left">
                                            <a href="#"><img class="media-object mr-3" src="{{asset('assets/images/avatar/3.png')}}" alt="..."></a>
                                        </div>
                                        <div class="media-body">
