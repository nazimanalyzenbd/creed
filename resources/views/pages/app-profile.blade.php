                            ...
                            <div class="card-body">
                                ...
                                <div class="profile-news mt-4 pb-3">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="{{asset('assets/images/profile/5.jpg')}}" alt="image" class="mr-3">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="{{asset('assets/images/profile/6.jpg')}}" alt="image" class="mr-3">
                                        <div class="media-body">
                                            <h5 class="m-b-5">John Tomas</h5>
                                            <p>I shared this on my fb wall a few months back, and I thought I'd share it here again because it's such a great read</p>
                                        </div>
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="{{asset('assets/images/profile/7.jpg')}}" alt="image" class="mr-3">
                                        <div class="media-body">
                                            <h5 class="m-b-5">John Tomas</h5>
                                            <p>I shared this on my fb wall a few months back, and I thought I'd share it here again because it's such a great read</p>
                                        </div>
