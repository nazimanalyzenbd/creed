...
return new class extends Migration
{
    ...
    {
        Schema::create('t_business_sub_categories', function (Blueprint $table) {
            $table->id();
            $table->string('category_id', 11); //from category table
    ...
    {
        Schema::dropIfExists('t_business_sub_categories');
    }
};
